...
#     parser.add_argument('--base_c_lr', type=float, default=1, help="client-side model learning rate")
    ...
    parser.add_argument('--cutlayer', type=int, default=1,help="从哪层开始作为server-side")
    parser.add_argument('--noniid_ratio', type=float, default=1.0, help="Use non-iid data across clients. 按non-iid的比例为client分配数据")
