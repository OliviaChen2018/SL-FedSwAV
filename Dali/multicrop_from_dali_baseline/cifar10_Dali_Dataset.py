...
class DaliTrainPipe_CIFAR_multicrop(Pipeline): # 这个pipeline就相当于是在构造数据集
    def __init__(self, data, targets, batch_size, num_threads = 4, device_id=0, size_crops=[224], nmb_crops = [2], min_scale_crops=[0.14], max_scale_crops=[1], dali_cpu=False, local_rank=0, world_size=1, cutout=0, output_ndim=None):
